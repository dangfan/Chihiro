Ext.define('Chihiro.controller.message.WhitePanel', {
    ...
    init: function() {
        ...
        canvas.addEventListener('mousedown',canvasMouseHandler,false);
        canvas.addEventListener('mousemove',canvasMouseHandler,false);
        canvas.addEventListener('mouseup',canvasMouseHandler,false);
    },

    launch: function(){
    },

    canvasMouseHandler:function(ev){
        var started = false;
    var x, y;
    ...
    x -= RoCanvas.offsetLeft;
    y -= RoCanvas.offsetTop;
    switch(ev.type)
    {
        case "mousedown":
            started = false;
